    ...
    return (
        ...
        <div className="cardcontainer">
            ...
            <div className="footer">
                <p><a className="waves-effect waves-light btn1" href="#">Read More</a><a id="heart"><span className="like"><i className="fab fa-gratipay"></i>Like</span></a></p>
